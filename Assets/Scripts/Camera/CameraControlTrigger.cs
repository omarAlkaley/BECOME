...
public class CameraControlTrigger : MonoBehaviour
{
	...
	private void OnTriggerEnter2D( Collider2D collision )
	{
		...
		{
			Vector2 exitTrigger = ( collision.transform.position - _coll.bounds.center ).normalized;
			if (customInspectorObjects.swapCamera && customInspectorObjects.cameraOnLeft != null && customInspectorObjects.cameraOnRight !=null)
			{
				CameraManager.instance.SwapCamera(customInspectorObjects.cameraOnLeft , customInspectorObjects.cameraOnRight , exitTrigger);
			}
